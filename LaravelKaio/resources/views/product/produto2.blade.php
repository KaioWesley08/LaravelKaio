      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
            ...
            <h2 class="mb-0 bread">Jim Beam Kentucky Straight</h2>
          </div>
        </div>
      </div>
    </section>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/prod-1.jpg" class="image-popup prod-img-bg"><img src="lib/images/prod-1.jpg" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3>Jim Beam Kentucky Straight</h3>
    				<div class="rating d-flex">
							...
							<p class="text-left mr-4">
								<a href="#" class="mr-2" style="color: #000;">100 <span style="color: #bbb;">Avaliação</span></a>
							</p>
							<p class="text-left">
    				...
    				<p>Um pequeno rio chamado Duden passa por seu lugar e abastece-o com a regelialia necessária. É um país paradisíaco, onde pedaços torrados de frases voam para a boca.</p>
						<div class="row mt-4">
	          	...
	          	<div class="w-100"></div>
	          	<div class="col-md-12">
	          		<p style="color: #000;">80 avaliações</p>
	          	</div>
          	</div>
          	<p><a href="cart.html" class="btn btn-primary py-3 px-5 mr-2">Adicionar ao carrinho</a><a href="cart.html" class="btn btn-primary py-3 px-5">Comprar agora</a></p>
    			</div>
    		</div>
          ...
          <div class="col-md-12 tab-wrap">
            ...
            <div class="tab-content bg-light" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-day-2-tab">
              	<div class="p-4">
	              	<h3 class="mb-4">Fabricado pela loja de bebidas</h3>
	              	<p>No caminho ela encontrou uma cópia. A cópia alertava o Texto Ceguinho, que de onde veio já teria sido reescrito mil vezes e tudo o que restasse de sua origem seria a palavra "e" e o Texto Ceguinho deveria virar e voltar ao seu, país seguro. Mas nada que o texto dissesse poderia convencê-la e por isso não demorou muito até que alguns redatores insidiosos a emboscaram, embebedaram-na com Longe e Parole e a arrastaram para sua agência, onde abusaram dela por causa de seus crimes.</p>
              	</div>
              </div>
            </div>
